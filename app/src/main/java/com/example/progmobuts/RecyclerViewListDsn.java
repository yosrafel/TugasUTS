...
import com.example.progmobuts.Adapter.DosenAdapter;
...
public class RecyclerViewListDsn extends AppCompatActivity {
    ...
    private void tambahData(){
        ...
        dosenList.add(new Dosen("001","Argo Wibowo", "S.T, M.T","argo@staff.ukdw.ac.id","Jl. Godean",R.drawable.orang));
        dosenList.add(new Dosen("002","Harianto Kristanto", "Ir. M.M, M.T","hariantok@staff.ukdw.ac.id","Jl. Godean",R.drawable.orang));
    }
}
